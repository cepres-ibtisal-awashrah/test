...
{
    protected const PHINX_LOG_TABLE_NAME = 'phinxlog';
    protected const WINDOWS_DATABASE = 'sqlsrv';
    ...
    public function createSchemaTable()
    {
        try {
            ...
            if ($this->getAdapterType() === static::WINDOWS_DATABASE) {
                $table->addColumn('version', 'biginteger', ['identity' => true]);
            } else {
