...
class YouTrack20182_defect_plugin extends Defect_plugin
{
	private $_api;
	...
	private static $_meta = array(
		...
		'version' => '1.0',
		'description' => 'YouTrack20182 defect plugin for TestRail',
		'can_push' => true,
		'can_lookup' => true,
		'default_config' =>
...
password=secret'
	...
	private function _get_api()
	{
		...
		$this->_api = new YouTrack20182_api($this->_address);
