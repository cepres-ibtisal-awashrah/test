...
<h1><img class="right noPrint w16" src="%RESOURCE%:images/report-assets/help.svg" alt="" title="<?php echo  lang('reports_ms_runs_info') ?>" /><?php echo  lang('reports_ms_runs') ?></h1>
...
<?php if ($activities_include): ?>
	<div class="chart-wrapper-outter">
		<div class="chart-wrapper-inner">
			<h1><img class="right noPrint w16" src="%RESOURCE%:images/report-assets/help.svg" alt="" title="<?php echo  lang('reports_ms_activity_info') ?>" /><?php echo  lang('reports_ms_activity') ?></h1>
			<?php if ($activity): ?>
				<?php
				$temp = [];
...
<?php if ($progress_include && $progress): ?>
	<div class="chart-wrapper-outter">
		<div class="chart-wrapper-inner">
			<h1><img class="right noPrint w16" src="%RESOURCE%:images/report-assets/help.svg" alt="" title="<?php echo  lang('reports_ms_progress_info') ?>" /><?php echo  lang('reports_ms_progress') ?></h1>
			<?php if ($burndown): ?>
				<?php
				$temp = [];
...
<?php if ($tests_include && $runs_noplan): ?>
	...
	<h1><img class="right noPrint w16" src="%RESOURCE%:images/report-assets/help.svg" alt="" title="<?php echo  lang('reports_ms_tests_info') ?>" /><?php echo  lang('reports_ms_tests') ?></h1>
