...
<div class="statsContainer statsContainerHighlighted">
	...
	<div class="statsRight" style="width: 225px">
		<?php if ($progress->projected_end_date === null): ?>
			<span class="estimate"><?php echo  lang('runs_progress_estimate_unknown') ?></span><br />
			<span class="secondary"><em><?php echo  lang('runs_progress_estimate_no_accuracy_nohelp') ?></em></span>
		<?php else: ?>
			...
			<span class="secondary"><em><?php echo  lang('runs_progress_estimate_high_accuracy_nohelp') ?></em></span>
			<?php else: ?>
			<span class="secondary"><em><?php echo  lang('runs_progress_estimate_low_accuracy_nohelp') ?></em></span>
			<?php endif ?>
		<?php endif ?>
	</div>
	<div class="statsContent" style="max-width: 450px; margin-right: 240px">
		<p style="margin: 0"><?php echo  lang('runs_progress_estimate_desc_many') ?></p>
	</div>
	<div style="clear: both"></div>
</div>
<?php endif ?>
...
<div class="statsContainer">
	...
	<div class="statsRight" style="width: 225px">
		...
		<?php endif ?>
		<p style="margin: 0"><?php echo  lang('runs_progress_running_completed') ?>
		...
		<?php if (isset($progress->elapsed)): ?>
			<?php echo  lang('runs_progress_running_elapsed') ?>
				<?php echo  timespan::format_hours($progress->elapsed) ?><br />
		<?php endif ?>
		<?php echo  lang('runs_progress_running_tests_day') ?> <?php echo  $progress->tests_per_day ?><br />
		<?php echo  lang('runs_progress_running_hours_day') ?>
	...
	<div class="statsContent" style="max-width: 450px; margin-right: 240px">
		<?php if ($is_completed): ?>
		<p style="margin: 0"><?php echo  langf('runs_progress_running_since_completed_many', 
			timespan::format_diff($completed_on, $progress->started_on), 
			date::format_short_date($progress->started_on),
			date::format_short_date($completed_on)) ?></p>
		<?php else: ?>		
		<p style="margin: 0"><?php echo  langf('runs_progress_running_since_many', 
...
<div class="statsContainer print-break">
	<div style="clear: both"></div>
	<div class="statsIcon">
	...
	<div class="statsContent">
		<table class="grid">
			...
			<tr class="header noBorder" style="background: #E0E0E0">
				<th><?php echo  lang('runs_progress_stats_metric') ?></th>
				<th><?php echo  lang('runs_progress_stats_by_estimate') ?></th>
				<th><?php echo  lang('runs_progress_stats_by_forecast') ?></th>
			</tr>
			<tr class="noBorder">
				<td><?php echo  lang('runs_progress_stats_completed') ?></td>
			...
			<tr class="noBorder">
				<?php if ($is_completed): ?>
				<td><?php echo  lang('runs_progress_stats_notcompleted') ?></td>
				<?php else: ?>
				<td><?php echo  lang('runs_progress_stats_todo') ?></td>
				<?php endif ?>
			...
			<tr class="noBorder">
				<td><?php echo  lang('runs_progress_stats_total') ?></td>
