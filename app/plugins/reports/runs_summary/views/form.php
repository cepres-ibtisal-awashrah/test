...
<div class="tabs">
	<div class="tab-header">
		<a href="javascript:void(0)" class="tab1 <?php echo  $tab == 1 ? 'current' : '' ?>" rel="1"
			...
			<?php echo  lang('reports_rs_form_runs_single') ?>
			<?php else: ?>
			<?php echo  lang('reports_rs_form_runs') ?>
			<?php endif ?>
		</a>
		<a href="javascript:void(0)" class="tab2 <?php echo  $tab == 2 ? 'current' : '' ?>" rel="2"
			onclick="App.Tabs.activate(this)"><?php echo  lang('reports_rs_form_details') ?></a>
		<a href="javascript:void(0)" class="tab3 <?php echo  $tab == 3 ? 'current' : '' ?>" rel="3"
			onclick="App.Tabs.activate(this)"><?php echo  lang('reports_rs_form_activity') ?></a>
		<a href="javascript:void(0)" class="tab4 <?php echo  $tab == 4 ? 'current' : '' ?>" rel="4"
			onclick="App.Tabs.activate(this)"><?php echo  lang('reports_rs_form_tests') ?></a>
	</div>
	<div class="tab-body tab-frame">
		...
		<div class="tab tab2 <?php echo  $tab != 2 ? 'hidden' : '' ?>">
			<p class="top"><?php echo  lang('reports_rs_form_details_include') ?></p>
			<div class="checkbox form-checkbox" style="margin-left: 15px">
				<label>
					<?php echo  lang('reports_rs_form_details_include_status') ?>
			...
			<div class="checkbox form-checkbox" style="margin-left: 15px">
				<label>
					<?php echo  lang('reports_rs_form_details_include_activity') ?>
			...
			<div class="checkbox form-checkbox" style="margin-left: 15px">
				<label>
					<?php echo  lang('reports_rs_form_details_include_progress') ?>
			...
			<div class="checkbox" style="margin-left: 15px; padding-bottom: 0">
				<label>
					<?php echo  lang('reports_rs_form_details_include_tests') ?>
