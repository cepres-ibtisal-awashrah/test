...
<h1 class="top"><img class="right noPrint w16" src="%RESOURCE%:images/report-assets/help.svg" alt="" title="<?php echo  lang('reports_rds_runs_header_info') ?>" /><?php echo  lang('reports_rds_runs_header') ?></h1>

<?php if ($runs): ?>
<div class="help" style="margin-bottom: 1em">
	<img class="w16" src="%RESOURCE%:images/report-assets/help.svg"  
		alt="" />
	<p><?php echo  lang('reports_rds_runs_help') ?></p>
...
?>
<?php else: ?>
	<p><?php echo  lang('reports_rds_runs_empty') ?></p>
<?php endif ?>

<h1><img class="right noPrint w16" src="%RESOURCE%:images/report-assets/help.svg" alt="" title="<?php echo  lang('reports_rds_ref_header_info') ?>" /><?php echo  lang('reports_rds_ref_header') ?></h1>
...
<?php if ($references && $references->reference_count > 0): ?>
	...
	?>
<?php else: ?>
	<p><?php echo  lang('reports_rds_ref_empty') ?></p>
<?php endif ?>
