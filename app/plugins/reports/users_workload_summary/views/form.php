...
<div class="tabs">
	<div class="tab-header">
		<a href="javascript:void(0)" class="tab1 <?php echo  $tab == 1 ? 'current' : '' ?>" rel="1"
			onclick="App.Tabs.activate(this)"><?php echo  lang('reports_uws_form_users') ?></a>
		<a href="javascript:void(0)" class="tab2 <?php echo  $tab == 2 ? 'current' : '' ?>" rel="2"
			...
			<?php echo  lang('reports_uws_form_runs_single') ?>
			<?php else: ?>
			<?php echo  lang('reports_uws_form_runs') ?>
			<?php endif ?>
		</a>
		<a href="javascript:void(0)" class="tab3 <?php echo  $tab == 3 ? 'current' : '' ?>" rel="3"
			onclick="App.Tabs.activate(this)"><?php echo  lang('reports_uws_form_tests') ?></a>
	</div>
	<div class="tab-body tab-frame">
		<div class="tab tab1 <?php echo  $tab != 1 ? 'hidden' : '' ?>">
			...
			<p><?php echo  lang('reports_uws_form_tests_details') ?></p>
			<div class="checkbox form-checkbox" style="margin-left: 15px">
				<label>
					<?php echo  lang('reports_uws_form_tests_include_summary') ?>
			...
			<div class="checkbox" style="margin-left: 15px">
				<label>
					<?php echo  lang('reports_uws_form_tests_include_tests') ?>
		...
		<div class="tab tab3 <?php echo  $tab != 3 ? 'hidden' : '' ?>">
			...
			<?php $report_obj->render_control(
				...
				array(
					...
					'intro' => lang('reports_uws_form_tests_limit')
				)
			) ?>
		</div>
	</div>
