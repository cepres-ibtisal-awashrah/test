...
/**
 * Cases Result Coverage report for TestRail
 *
 * Copyright Gurock Software GmbH. All rights reserved.
 *
 * This is the TestRail report for displaying the result coverage for
 * test cases in a coverage matrix.
 *
 * http://www.gurock.com/testrail/
 */

class Cases_result_coverage_report_plugin extends Report_plugin
{
	private $_controls;
	...
	public function validate_form($context, $input, $validation)
	{
			...
			!$input['custom_cases_include_comparison'])
		{
			$validation->add_error(
				lang('reports_crc_form_cases_required')
			);
	...
	public function run($context, $options)
	{
		...
		// Get the test suite related data first.
		...
		if ($show_coverage && $run_ids && $case_ids)
		{
			$results_latest = 
