...
<div class="tabs">
	<div class="tab-header">
		<a href="javascript:void(0)" class="tab1 <?php echo  $tab == 1 ? 'current' : '' ?>" rel="1"
			...
			<?php echo  lang('reports_cds_form_runs_single') ?>
			<?php else: ?>
			<?php echo  lang('reports_cds_form_runs') ?>
			<?php endif ?>
		</a>
		<a href="javascript:void(0)" class="tab2 <?php echo  $tab == 2 ? 'current' : '' ?>" rel="2"
			onclick="App.Tabs.activate(this)"><?php echo  lang('reports_cds_form_cases') ?></a>
	</div>
	<div class="tab-body tab-frame">
		...
		<div class="tab tab2 <?php echo  $tab != 2 ? 'hidden' : '' ?>">
			...
			<p><?php echo  lang('reports_cds_form_cases_columns_extra') ?></p>
			<div class="checkbox form-checkbox" style="margin-left: 15px">
				<label>
					<?php echo  lang('reports_cds_form_cases_columns_comparison') ?>
			...
			<div class="checkbox" style="margin-left: 15px; padding-top: 0">
				<label>
					<?php echo  lang('reports_cds_form_cases_columns_summary') ?>
